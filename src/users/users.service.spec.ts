...
describe('UsersService', () => {
  ...
  it('should register user', async () => {
    ...
    expect(mockUsersRepository.register).toHaveBeenCalledWith({
      name,
      email,
  ...
  it('should find user by id', () => {
    ...
    expect(mockUsersRepository.findByField).toHaveBeenCalledWith({
      _id: userId,
    });
  });
  ...
  it('should update password', async () => {
    ...
    expect(
      await usersService.updatePassword(userId, oldPassword, newPassword),
    ).toBeDefined();
    expect(mockUsersRepository.findByField).toHaveBeenCalledWith({
      _id: userId,
    });
