...
import { ExtendedRequestMockFactory, MulterFileMockFactory } from "../users/users.mock.factories";
...
describe('ContactsController', () => {
    ...
    it("should create contact", () => {
        ...
        expect(contactsController.create(extendedReq, createContactObj)).toBeDefined();
        expect(mockContactsService.create).toBeCalledWith(extendedReq.user.id, createContactObj);
    ...
    it("should find all contacts", () => {
        ...
        expect(contactsController.findAll(extendedReq, { limit, skip })).toBeDefined();
        expect(mockContactsService.findAll).toBeCalledWith(extendedReq.user.id, limit, skip);
    ...
    it("should update contact", () => {
        ...
        expect(contactsController.update(extendedReq, id, updateContactObj)).toBeDefined();
        expect(mockContactsService.update).toBeCalledWith(extendedReq.user.id, id, updateContactObj);
    ...
    it("should update contact avatar", () => {
        ...
        expect(contactsController.updateAvatar(extendedReq, fileMock, id)).toBeDefined();
        expect(mockContactsService.updateAvatar).toBeCalledWith(extendedReq.user.id, id, fileMock);
    ...
    it("should update friends", () => {
        ...
        expect(contactsController.updateFriends(extendedReq, id, isFriend)).toBeDefined();
        expect(mockContactsService.updateFriends).toBeCalledWith(extendedReq.user.id, id, isFriend);
